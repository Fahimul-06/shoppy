...
router.put('/profile', requireSeller, asyncHandler(async (req, res) => {
  const { name, shopName, shopLogo, shopBanner, shopAddress, businessType, nidNumber, tinNumber, bankName, bankAccount } = req.body;
  Object.assign(req.seller, {
    ...
    shopBanner: shopBanner ?? req.seller.shopBanner,
