...
type AdminTab = 'dashboard' | 'sellers' | 'customers' | 'products' | 'sales' | 'orders' | 'returns' | 'cancellations' | 'messages' | 'customerCare' | 'promos' | 'notifications' | 'settings';
