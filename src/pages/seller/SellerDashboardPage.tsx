          ...
          <div className="grid lg:grid-cols-2 gap-5">
            <div className="bg-white rounded-2xl p-5 border">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                ...
                <div className="sm:col-span-2">
                  <label className="text-xs font-bold text-gray-500 mb-2 block">Shop banner photo</label>
                  <ImageUploader value={profileForm.shopBanner || ''} token={getToken('seller')} onChange={(url) => updateProfile('shopBanner', url)} />
                  <p className="text-xs text-gray-400 mt-1">This banner appears at the top of your public seller shop page.</p>
                </div>
